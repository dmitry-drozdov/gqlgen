...
[code]: https://github.com/dmitry-drozdov/gqlgen/blob/master/graphql/handler/transport/websocket.go
...
After regenerating your code with `go run github.com/dmitry-drozdov/gqlgen generate` you'll find a
