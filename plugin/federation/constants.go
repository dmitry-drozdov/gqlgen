...
var builtins = config.TypeMap{
	"_Service": {
		Model: config.StringList{
			"github.com/dmitry-drozdov/gqlgen/plugin/federation/fedruntime.Service",
		},
	},
	"_Entity": {
		Model: config.StringList{
			"github.com/dmitry-drozdov/gqlgen/plugin/federation/fedruntime.Entity",
		},
	},
	"Entity": {
		Model: config.StringList{
	...
	"_Any": {
		Model: config.StringList{"github.com/dmitry-drozdov/gqlgen/graphql.Map"},
	},
	"federation__Scope": {
		Model: config.StringList{"github.com/dmitry-drozdov/gqlgen/graphql.String"},
	},
	"federation__Policy": {
		Model: config.StringList{"github.com/dmitry-drozdov/gqlgen/graphql.String"},
	},
