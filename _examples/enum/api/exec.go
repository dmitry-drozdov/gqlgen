...
import (
	...
	"github.com/dmitry-drozdov/gqlgen/_examples/enum/model"
...
enum IntTyped @goModel(model: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.IntTyped") {
    ONE @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.IntTypedOne")
    TWO @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.IntTypedTwo")
}

enum IntUntyped @goModel(model: "github.com/dmitry-drozdov/gqlgen/graphql.Int") {
    ONE @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.IntUntypedOne")
    TWO @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.IntUntypedTwo")
}

enum StringTyped @goModel(model: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.StringTyped") {
    ONE @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.StringTypedOne")
    TWO @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.StringTypedTwo")
}

enum StringUntyped @goModel(model: "github.com/dmitry-drozdov/gqlgen/graphql.String") {
    ONE @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.StringUntypedOne")
    TWO @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.StringUntypedTwo")
}
...
enum VarTyped @goModel(model: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.VarTyped") {
    TRUE @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.VarTypedTrue")
    FALSE @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.VarTypedFalse")
}

enum VarUntyped @goModel(model: "github.com/dmitry-drozdov/gqlgen/graphql.Boolean") {
    TRUE @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.VarUntypedTrue")
    FALSE @goEnum(value: "github.com/dmitry-drozdov/gqlgen/_examples/enum/model.VarUntypedFalse")
}
