...
func _Mutation_createUser(ctx context.Context, ec *executionContext, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *github.com/dmitry-drozdov/gqlgen/codegen/testserver/usefunctionsyntaxforexecutioncontext.User`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func _Mutation_deleteUser(ctx context.Context, ec *executionContext, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *github.com/dmitry-drozdov/gqlgen/codegen/testserver/usefunctionsyntaxforexecutioncontext.MutationResponse`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func _Query_getEntity(ctx context.Context, ec *executionContext, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/dmitry-drozdov/gqlgen/codegen/testserver/usefunctionsyntaxforexecutioncontext.Entity`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func _Subscription_userCreated(ctx context.Context, ec *executionContext, field graphql.CollectedField) (ret func(ctx context.Context) graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be <-chan *github.com/dmitry-drozdov/gqlgen/codegen/testserver/usefunctionsyntaxforexecutioncontext.User`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return nil
